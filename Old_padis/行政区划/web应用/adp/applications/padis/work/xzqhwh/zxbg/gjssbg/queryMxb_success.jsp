...
<logic:present name="ITEMS">
	<display:table name="ITEMS" id="mxbMap" align="center"    class="tab"  requestURI="GjssbgService.queryMxb.do">
...
<display:table name="ITEMS" align="center" id="mxbMap" requestURI="GjssbgService.queryMxb.do"  class="tab">
