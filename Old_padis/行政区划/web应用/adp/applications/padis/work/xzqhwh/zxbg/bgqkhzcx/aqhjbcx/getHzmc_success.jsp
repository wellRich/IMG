...
<BODY>
	...
	<iframe src="AqhjbcxService.queryMxb.do?XZQH_DM=000000000000000&HZMC=<%=mrhzmc%>" id="iframe1" name="iframe1" width="100%" onload="this.height=iframe1.document.body.scrollHeight" scrolling="no" frameborder="0"></iframe>
</body>
</html>