...
<div id="div2">
	...
	<center>
		<button onClick="addXzqhsqb();" accesskey="a">保存明细(<U>A</U>)</button>
		
		<button onClick="bangZhu();" accesskey="b">帮助(<U>B</U>)</button>
	...
	<div id="div1">
		<div id="xzqh" height="100%" width="100%">
		 ...
		 <center>
			<button id="btn_save" accesskey="s" onclick="saveXzqh()">提 交(<u>S</u>)</button>
