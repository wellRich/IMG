...
*/
function bangZhu(){
	showMessage("只能变更本级区划以下的区划代码名称,变更说明如下:\n新增:新增一个原来没有的区划;\n变更:区划地域的名称,代码有变动;\n并入:撤销原有区划,并入一个已经存在的区划;\n迁移:撤销原有区划,迁入另外上一级行政层之下,此时,区划名称和代码均有变化;\n重用变更:是村级相互变更时使用的功能,如:A村  变为  B村,B村  变为 A村;\n有其它问题请联系:\n技术支持电话:010-62152711\n传    真:010-62128056\n邮    件:padisadim@163.com.");
}
...
function saveXzqh(){
	...
	if(ringFlag=="1"){
		var service0 = new Service("com.padis.business.xzqhwh.zxbg.bgdzgl.bgdzblr.BgdzblrService.checkSqd");
		var resultXml0 = service0.doService(paramXml);
		var code0 = service0.getCode();  //返回结果的状态
		var message0 = service0.getMessage();  //返回的信息
		if(code0==2000){
			var service = new Service("com.padis.business.xzqhwh.zxbg.bgdzgl.bgdzblr.BgdzblrService.addXzqhbgsqb");
