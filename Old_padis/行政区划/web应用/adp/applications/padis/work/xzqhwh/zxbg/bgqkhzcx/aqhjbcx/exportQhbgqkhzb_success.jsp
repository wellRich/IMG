...
String filename = new String(new String("按区划级别分的区划变更情况汇总表").getBytes("GBK"),"ISO8859-1");
...
response.setHeader("Content-Disposition", "attachment;filename="+filename+".xls");
	...
	short rowHeight = 330;
		...
		HSSFSheet sheet = wb.createSheet("按区划级别分的区划变更情况汇总表");// 建立新的sheet对象
		...
		cellTitle.setCellValue("按区划级别分的区划变更情况汇总表");
