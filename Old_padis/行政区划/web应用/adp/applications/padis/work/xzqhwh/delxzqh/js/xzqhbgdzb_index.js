...
function getXjXzqh(obj,temp){
	...
	paramXml = paramXml+"<SJXZQH>"+obj.value+"</SJXZQH><FHJD>"+fhjd+"</FHJD><DB>V_DM_XZQH</DB></map></ROOT>";
...
function deleteXzqh(){
	...
	if(xzqh_dm==""){
		...
		if(confirm("您确实要删除该行政区划吗？")){
			window.open("DelxzqhService.deleteXzqh.do?XZQH_DM="+xzqh_dm+"&FLAG="+flag,"delIframe");	
		}
	}
}