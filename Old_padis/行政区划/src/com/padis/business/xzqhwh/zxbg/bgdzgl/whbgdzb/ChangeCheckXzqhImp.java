...
public class ChangeCheckXzqhImp extends CheckXzqhImp{
			...
			for(int i=0;i<cnt ;i++){
				...
				if(bglx_dm.equals(Common.ADD)){
					...
					if(xzqh_dm.equals(mbxzqh_dm)){
						...
						.append("中被并入到“").append(xzqh_dm).append("”下，请先删除此调整说明！");
						flag=false;
						throw new Exception(message.toString());
					}else{
					...
					if(srcXzqh_dm.equals(mbxzqh_dm)){
						...
						flag=false;
						throw new Exception(message.toString());
					}else if(xzqh_dm.equals(Common.getSjxzqhdm(mbxzqh_dm))){
						message.append("现区划代码“").append(xzqh_dm).append("”").append(msg)
						...
						if(mbxzqh_dm.indexOf(xzqh_jbdm)>-1){
							message.append("现区划代码“").append(xzqh_dm).append("”的下级区划“").append(Common.getSjxzqhdm(mbxzqh_dm)).append("”")
					...
					if(xzqh_dm.equals(ysxzqh_dm)){
						...
						if(ysxzqh_dm.indexOf(xzqh_jbdm)>-1){
							message.append("现区划代码“").append(xzqh_dm).append("”的下级区划“").append(ysxzqh_dm).append("”")
