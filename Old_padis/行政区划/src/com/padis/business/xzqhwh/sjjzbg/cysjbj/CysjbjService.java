 ...
 * @version 1.0
 */
public class CysjbjService extends XtwhBaseService {
	 ...
	 *
	 */
	public CysjbjService() {
		mgr = new CysjbjManager();
	}
	 ...
	 * @exception 无
	 */
	public void queryDif() {
		try {
			XMLDataObject xdo = uwa.getArgXml();
			long[] args = new long[]{-1,0};
			String zipList = mgr.queryDif(xdo,args,uwa.getQx_swjg_dm());
			XmlStringBuffer xsBuf = new XmlStringBuffer();
			xsBuf.appendHead("ROOT");
			xsBuf.appendHead("Result");
			xsBuf.appendHead("MAP");
