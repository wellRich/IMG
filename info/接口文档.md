...
| - | - | - | - |-|
| zoningCode | String | 是 | 区划代码，后期可以从session中取得 |370102000000000|
...
| 参数名 | 数据类型 | 是否必填 | 参数说明 |默认值
| - | - | - | - |-|
| zoningCode | String | 是 | 区划代码 |370000000000000|
...
`[{"total": 8,"zoningName": "370000000000000","zoning_name": "济南市中区","confirmed": 7,"zoningCode": "370000000000000"}]`
