    ...
    $.ajax({
      ...
      success: function (da) {
        ...
        if (res.rtnCode === "000000") {
          ...
          zoningChangeRequestList(rozc_shenhe_vm.data.zoningCode, rozc_shenhe_vm.data.pageSize, rozc_shenhe_vm.data.pageIndex, rozc_shenhe_vm.data.totalRecord);
        }
      }
    })
  }
