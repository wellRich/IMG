define(['jquery','bootstrap','scroll','feeds'], function ($) {
    ...
    $(document).ready(function () {
        ...
        (function () {
            ...
            $('body').on('click touchstart', '#menu-toggle', function (e) {
                ...
                $('.main-container').toggleClass('main-container-center');
