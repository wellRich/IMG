define(['avalon', 'jquery', 'bootstrap', 'text!./rzc_luru.js'], function (avalon, _rzc_luru) {
  ...
  function getBrothersZoning(zoningCode) {
    $.ajax({
      url: 'http://localhost:8251/zoningChangeManager/getZoningByAssCode?zoningCode=' + zoningCode,
      type: 'GET',
      success: function (da) {
        var res = JSON.parse(da);
      }
...
////////////////////////gyk//////////////////////////////////////////////
     ...
     */
    ZC.checkInfo = function (changeInfo) {
        //变更状态
    ...
    ZC.getSuperiorZoningCode = function (zoningCode) {
        ...
        if (zoningCode.substring(0, 2).equals("00")) {
            return "";
        } else if (zoningCode.substring(2, 4).equals("00")) {
            superiorZoningCode = "000000000000000";
        } else if (zoningCode.substring(4, 6).equals("00")) {
            superiorZoningCode = zoningCode.substring(0, 2) + "0000000000000";
        } else if (zoningCode.substring(6, 9).equals("000")) {
            superiorZoningCode = zoningCode.substring(0, 4) + "00000000000";
        } else if (zoningCode.substring(9, 12).equals("000")) {
            superiorZoningCode = zoningCode.substring(0, 6) + "000000000";
        } else if (zoningCode.substring(12, 15).equals("000")) {
