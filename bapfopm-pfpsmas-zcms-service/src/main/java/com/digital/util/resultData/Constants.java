...
public class Constants {
    ...
    * 发布失败
    * */
    public final static String RTN_RELEASE_FAIL = "发布失败！ 具体原因。。。。。不知道";

    /*
    * 文件路径为空
    * */
    public final static String RTN_PATH_ISMPTY = "文件路径为空";
    /*
    * 文件不存在
    * */
    public final static String RTN_FILE_EXIST = "文件路径为空";
