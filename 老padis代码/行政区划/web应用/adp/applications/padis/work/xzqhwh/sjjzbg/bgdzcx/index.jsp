...
<html>
	...
	<body >
		...
		<iframe  src="BgdzcxService.queryZip.do?PAGESIZE=10" id="operationArea1" name="operationArea1" width="100%" onload="this.height=operationArea1.document.body.scrollHeight" scrolling="no" frameborder="0" ></iframe>
		<iframe src="BgdzcxService.queryDzb.do?PAGESIZE=10" id="operationArea2" name="operationArea2" width="100%" onload="this.height=operationArea2.document.body.scrollHeight" scrolling="no" frameborder="0" ></iframe>
	</body>
</html>
