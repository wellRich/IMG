...
<html>
	...
	<body onload="initPage();">
		<form method="POST" name="form1" action="">
			...
			<logic:present name="SQDLIST">
				<display:table name="SQDLIST" id="sqdMap" align="center"
					...
					requestURI="SqdwhService.initSqd.do">
		 ...
		 <center>
			 ...
			 <button id="btn_delete" accesskey="c"  onclick="commitSqd()">提 交(<u>C</u>)</button>
		...
		<hr></hr>
				<iframe src="SqdwhService.queryMxb.do?PAGESIZE=10" id="iframe1" name="iframe1" width="100%" onload="this.height=iframe1.document.body.scrollHeight" frameborder="0" ></iframe>
	</body>
</html>
