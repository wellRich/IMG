...
<logic:present name="ITEMS">
	<display:table name="ITEMS" id="mxbMap" align="center"  pagesize="10"   class="tab"  requestURI="SqdwhService.queryMxb.do">
...
<display:table name="ITEMS" align="center" id="mxbMap" requestURI="SqdwhService.queryMxb.do"  pagesize="10" class="tab">
...
<input type="hidden" id="check_value" value=""/> 
 <center>
 	  <button id="btn_delete" disabled="disabled"  accesskey="d"  onclick="deleteMxb('<%=sbxzqh_dm%>')">删 除(<u>D</u>)</button>
