			...
			for(int i=0;i<cnt ;i++){
				...
				if(bglx_dm.equals(Common.ADD)){
					if(srcXzqh_dm.equals(mbxzqh_dm)){
						message.append("原区划代码“").append(srcXzqh_dm).append("”").append(msg)
						.append("中被再次使用，请先删除此调整说明！");
						flag=false;
						throw new Exception(message.toString());
					}else if(mbxzqh_dm.indexOf(xzqh_jbdm)>-1){
						message.append("现区划代码“").append(destXxzqh_dm).append("”").append(msg).append("下有新增区划").append("，请先删除此调整说明！");
						flag=false;
						throw new Exception(message.toString());
					}else{
						continue;
					...
					if(srcXzqh_dm.equals(mbxzqh_dm)){
						...
						message.append("原区划代码“").append(srcXzqh_dm).append("”的上级区划“").append(ysxzqh_dm).append("”")
						.append(msg).append("中已被变更为：").append(mbxzqh_dm).append("，请先删除此调整说明！");
						flag=false;
						throw new Exception(message.toString());					
					}
					if(destXxzqh_dm.equals(ysxzqh_dm)){
						message.append("现区划代码“").append(destXxzqh_dm).append("”").append(msg)
						.append("中已被变更为“").append(mbxzqh_dm).append("”，请先删除此调整说明！");
						flag=false;
						throw new Exception(message.toString());
					}else{
						if(ysxzqh_dm.indexOf(xzqh_jbdm)>-1){
							message.append("现区划代码“").append(destXxzqh_dm).append("”的下级区划“").append(ysxzqh_dm).append("”")
							.append(msg).append("中已被变更为：").append(mbxzqh_dm).append("，请先删除此调整说明！");
							flag=false;
							throw new Exception(message.toString());
						}else if(checkSjXzqh(destXxzqh_dm,ysxzqh_dm)){
							message.append("现区划代码“").append(destXxzqh_dm).append("”的上级区划“").append(Common.getSjxzqhdm(ysxzqh_dm)).append("”")
							.append(msg).append("中已被变更为：").append(mbxzqh_dm).append("，请先删除此调整说明！");
							flag=false;
							throw new Exception(message.toString());					
						}else{
					...
					if(destXxzqh_dm.equals(mbxzqh_dm)){
						...
						.append("中被并入到“").append(destXxzqh_dm).append("”下，请先删除此调整说明！");
						flag=false;
						throw new Exception(message.toString());
					}else{
						if(mbxzqh_dm.indexOf(xzqh_jbdm)>-1){
							message.append("现区划代码“").append(destXxzqh_dm).append("”");
							if(!destXxzqh_dm.equals(ysxzqh_dm)){
					...
					if(destXxzqh_dm.equals(mbxzqh_dm)){
						...
						if(ysxzqh_dm.indexOf(xzqh_jbdm)>-1){
							...
							message.append("现区划代码“").append(destXxzqh_dm).append("”的上级区划“").append(ysxzqh_dm).append("”")
							.append(msg).append("中已被并入到：").append(mbxzqh_dm).append("下，请先删除此调整说明！");
							flag=false;
							throw new Exception(message.toString());					
						}else{
					...
					if(srcXzqh_dm.equals(mbxzqh_dm)){
						...
						if(mbxzqh_dm.indexOf(xzqh_jbdm)>-1){
							message.append("现区划代码“").append(destXxzqh_dm).append("”的下级区划“").append(Common.getSjxzqhdm(mbxzqh_dm)).append("”")
